              ...
              <div className="comment__list mt-5">
                ...
                <div className="single__comment d-flex gap-3">
                  ...
                  <div className="comment__content">
                    <h6 className=" fw-bold">Diya</h6>
                    <p className="section__description mb-0">14 July, 2022</p>
                    <p className="section__description">IT IS USEFUL & A GOOD PRODUCT. I HAVE USED IT ON MOUNTAINEERING. LIGHT IS BRIGHT AND CLEAR. MONETARY IT IS CHEAP ALSO.
                    </p>
